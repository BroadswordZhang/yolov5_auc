...
class ThirdDetect():
    ...
    def __call__(self, img, third_detect_classes):
        OUT = []
        ...
        if len(det):  # (n,6)
            ...
            for xmin, ymin, xmax, ymax, conf, cls in det:
                label = third_detect_classes[int(cls)]
