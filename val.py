...
from utils.metrics import ConfusionMatrix, ap_per_class, box_iou,AUROC
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/2_nd.yaml', help='dataset.yaml path')
